    ...
    return (
        <div className="min-h-screen bg-gray-50">
                ...
                <div className="max-w-7xl mx-auto px-8 py-4">
                    ...
                    <div className="flex space-x-1 border-b border-gray-200">
                        <button
                            ...
                            className={`px-6 py-3 font-medium rounded-t-lg transition-colors ${!showCreate && !showVoters && !showOtps && !showStats && !showReports
                        ...
                        <button
                            ...
                            className={`px-6 py-3 font-medium rounded-t-lg transition-colors ${showVoters
                        ...
                        <button
                            ...
                            className={`px-6 py-3 font-medium rounded-t-lg transition-colors ${showOtps
                        ...
                        <button
                            ...
                            className={`px-6 py-3 font-medium rounded-t-lg transition-colors ${showStats
                        ...
                        <button
                            ...
                            className={`px-6 py-3 font-medium rounded-t-lg transition-colors ${showReports
            ...
            <div className="max-w-7xl mx-auto p-8">
                {/* Elections Section - Default View */}
                {!showVoters && !showOtps && !showStats && !showReports && (
                    <div>
                        ...
                        {showCreate && (
                            <div className="bg-blue-50 p-6 rounded-lg mb-8 border-2 border-blue-200">
                                <h3 className="text-xl font-bold mb-4 text-blue-800">Create New Election</h3>
                                <input
                ...
                {/* Elections List - shown on Elections tab */}
                {!showVoters && !showOtps && !showStats && !showReports && (
